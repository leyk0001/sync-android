...
public class AttachmentsPullTest extends ReplicationTestBase {
    ...
    /**
     * Utility for reading writes. When we are writing attachments it might take a little time for
     * new revision to appear so we validate that the rev has incremented from what we currently
     * know about before deciding that we have the latest rev.
     * @param docId
     * @param currentRev
     * @return
     */
